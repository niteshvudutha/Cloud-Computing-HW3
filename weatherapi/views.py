...
from weatherapi.serializers import Weather_Details_Serializer, Date_Details_Serializer
...
class DateListViewSet(viewsets.ViewSet):
	...
	def list(self, request):
		...
		serializer = Weather_Details_Serializer(queryset, many=True)
		newdata = {}
		response = []
	...
	def create(self, request):
		serializer = Weather_Details_Serializer(data=request.data)
...
class DateViewSet(viewsets.ModelViewSet):
	queryset = WeatherAPI.objects.all()
	serializer_class = Weather_Details_Serializer
	permission_classes = [
